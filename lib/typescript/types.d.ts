...
export type ImageZoomUseGesturesProps = Pick<ImageZoomLayoutState, 'center'> & Pick<ImageZoomProps, 'minScale' | 'maxScale' | 'minPanPointers' | 'maxPanPointers' | 'isPanEnabled' | 'isPinchEnabled' | 'onInteractionStart' | 'onInteractionEnd' | 'onPinchStart' | 'onPinchEnd' | 'onPanStart' | 'onPanEnd'>;
